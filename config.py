...
OWNER_USERNAME = getenv("OWNER_USERNAME", "@daily_grief")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "amrita_alishaa_bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "AMRITA MSN")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "AMRITA_MSN")
EVALOP = list(map(int, getenv("EVALOP", "7110227169").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Jessythopa/NYKAAXBOT",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Amrita_update")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/8a2adb07d26e4a215cfe4.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://graph.org/file/8a2adb07d26e4a215cfe4.jpg"
)
